        ...
        html += `
            ...
            <div class="card">
                ...
                <div class="card-footer" style="border:2px solid white">
                 ...
                 <a href="#list">  <button  onClick ="Ajout('${image.id}')" class="btn btn-success" id="desactive" >AJOUTER </button></a>
...
function Ajout(e) {
    ...
    tabproduit.forEach(element => {
        ...
        if (element.id == e) {
            ...
            input.parentNode.children[3].children[0].setAttribute("disabled", "");
